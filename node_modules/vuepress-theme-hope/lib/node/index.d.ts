...
interface PrismjsOptions extends PrismjsPluginOptions {
    /**
     * Single theme
     *
     * 单个主题
...
type ThemePrismJsPluginHelper = Helper<PrismjsOptions | boolean>;
 ...
 */
declare const usePrismjsPlugin: (app: App, options?: PrismjsOptions | true) => void;
/**
 * @private
 *
